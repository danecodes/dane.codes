...
### Font Family
- **Display**: Cal Sans — used for all headings and display text. A geometric, friendly display face. Source: `https://github.com/calcom/font` or Google Fonts alternative.
- **Body**: Inter — used for body text, buttons, captions, and UI elements. Stack: `Inter, ui-sans-serif, system-ui, -apple-system, sans-serif`

### Hierarchy

| Role | Font | Size | Weight | Line Height | Letter Spacing | Notes |
|------|------|------|--------|-------------|----------------|-------|
| Display / Hero | Cal Sans | 82px (5.13rem) | 600 | 1.00 (tight) | -2.05px | Maximum impact, billboard scale |
| Section Heading | Cal Sans | 56px (3.5rem) | 600 | 0.95 (ultra-tight) | normal | Feature section anchors |
| Sub-heading Large | Cal Sans | 48px (3rem) | 600 | 0.95 (ultra-tight) | normal | Secondary section titles |
| Sub-heading | Cal Sans | 32px (2rem) | 600 | 1.15 (tight) | normal | Card headings, feature names |
| Card Title | Cal Sans | 30px (1.88rem) | 600 | 1.20 (tight) | normal | Mid-level headings |
| Feature Title | Cal Sans | 24px (1.5rem) | 600 | 1.33 | normal | Small headings |
| Body / Button | Inter | 16px (1rem) | 300 | 1.50 | -0.2px | Standard body, button text |
| Button Uppercase | Inter | 16px (1rem) | 600 | 1.50 | normal | Uppercase CTA labels |
| Caption / Link | Inter | 14px (0.88rem) | 500 | 1.43 | normal | Metadata, secondary links |

### Principles
- **Two-font division**: Cal Sans for all display and heading text, Inter for all body and UI text. This clean split creates a strong visual hierarchy through typeface alone.
...
- **Weight contrast**: Cal Sans at 600 (semibold) for headings, Inter at 300 (light) for body — weight reinforces the typeface division.
...
- Use Cal Sans at weight 600 for all headings, Inter at weight 300 for body text
...
- Don't use fonts other than Cal Sans (display) and Inter (body)
...
- Don't mix heading/body fonts — Cal Sans is never for body, Inter is never for display
...
- "Create a hero section on Warm Ivory (#fffaeb) with a massive Cal Sans headline at 82px weight 600, line-height 1.0, letter-spacing -2.05px. Mistral Black (#1f1f1f) text. Body text in Inter weight 300. Add a dark solid CTA button (#1f1f1f bg, white text, 12px padding, sharp corners) and a cream secondary button (#fff0c2 bg)."
- "Design a feature card on Cream (#fff0c2) with sharp corners (no border-radius). Apply the golden shadow system: rgba(127, 99, 21, 0.12) -8px 16px 39px as the primary layer. Title in Cal Sans at 32px weight 600, body in Inter at 16px weight 300."
...
5. Cal Sans at 600 for headings, Inter at 300 for body — describe emphasis through typeface, size, and color
