...
<Sketch src="/diagrams/ecp-arch.svg" caption="Your code talks to port 8060. The Roku does the thing. That's it." />
...
This is where it stops being a nice wrapper around curl.
...
<Sketch src="/diagrams/ecp-pipeline.svg" caption="roku-ecp turns raw SceneGraph XML into something you can actually query." />
